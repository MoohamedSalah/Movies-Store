...
namespace MoviesMoo.Models
{
    ...
    public partial class MoviesDBconnectionstring : DbContext
    {
        ...
        public virtual int spCreateMovie(string name, string genra, Nullable<System.DateTime> relateasDate, Nullable<System.DateTime> dateAdd, Nullable<int> memberAvalible, Nullable<double> numberInStock, byte[] moviesPhoto, string altPhoto, string doxContant, string trailerUrl)
        {
        ...
        public virtual int spEditeMovie(Nullable<int> iD, string name, string genra, Nullable<System.DateTime> relateasDate, Nullable<System.DateTime> dateAdd, Nullable<int> memberAvalible, Nullable<double> numberInStock, byte[] moviesPhoto, string altPhoto, string doxContant, string trailerUrl)
        {
