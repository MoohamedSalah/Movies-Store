...
namespace MoviesMoo.Models
{
    ...
    public partial class MoviesDBconnectionstring : DbContext
    {
        ...
        public virtual int spEditeMovies(Nullable<int> id, string name, string genre, Nullable<System.DateTime> releasDate, Nullable<System.DateTime> dateAdd, Nullable<double> numberInStock, Nullable<int> memberAvalible)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spEditeMovies", idParameter, nameParameter, genreParameter, releasDateParameter, dateAddParameter, numberInStockParameter, memberAvalibleParameter);
        }
    }
}
